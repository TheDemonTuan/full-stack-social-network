  ...
  return (
    <div className="relative overflow-hidden group col-span-1 shadow-2xl rounded-xl cursor-pointer hover:opacity-90">
      ...
      <div className="absolute bottom-8 left-0 right-0 grid place-items-center">
        <FaPlus className="bg-cyan-400 font-bold rounded-full text-black p-1 z-10 ring-4 ring-white group-hover:scale-105" size={28} />
      </div>
      <span className="absolute bottom-0 left-0 right-0 grid place-items-center text-black font-bold shadow-2xl text-xs bg-gray-100 h-1/5">
        Create Story
      </span>
    </div>
  );
